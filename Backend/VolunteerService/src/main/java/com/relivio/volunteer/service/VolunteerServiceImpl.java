...
public class VolunteerServiceImpl implements VolunteerService {
    ...
    public VolunteerResponse releaseVolunteer(Long volunteerId) {
        ...
        Long releasedReliefRequestId = volunteer.getAssignedReliefRequestId();
        volunteer.setAvailabilityStatus(AvailabilityStatus.AVAILABLE);
        ...
        unlinkReliefRequest(releasedVolunteer, releasedReliefRequestId);
    ...
    private void unlinkReliefRequest(Volunteer volunteer, Long reliefRequestId) {
        if (reliefRequestId == null) {
            return;
        }
        try {
